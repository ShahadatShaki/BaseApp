...
public class RoundShape extends ShapeOfView {
    ...
    public RoundShape(@NonNull Context context) {
        super(context);
        init(context, null);
    }

    public RoundShape(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public RoundShape(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            final TypedArray attributes = context.obtainStyledAttributes(attrs, R.styleable.RoundShape);
            topLeftRadius = attributes.getDimensionPixelSize(R.styleable.RoundShape_shape_roundRect, (int) topLeftRadius);
            topRightRadius = topLeftRadius;
            bottomLeftRadius = topLeftRadius;
            bottomRightRadius = topLeftRadius;
            borderColor = attributes.getColor(R.styleable.RoundShape_shape_roundRect_borderColor, borderColor);
            borderWidthPx = attributes.getDimensionPixelSize(R.styleable.RoundShape_shape_roundRect_borderWidth, (int) borderWidthPx);
            attributes.recycle();
        }
